...
<br>
		...
		<br>
		<p style="display:none;text-align:center;font-size:large;" id="progressbox" > <img  src="ressources\img/loader.gif" /> SVP veuillez patienter pendant le chargement du fichier !</p>
</body>
</html>
<?php
}
