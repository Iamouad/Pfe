...
//extraire l'adresse email de l'encadrant
    ...
    // $prof_result0 = mysql_query(,$con) or die ('Erreur : '.mysql_error() );
    $prof_result0 = $con->query($prof_select0) or die(print_r($prof_result0->errorInfo(), TRUE)) ;
    
    while($row0 = $prof_result0->fetch(PDO::FETCH_ASSOC)) {
