...
if (isset($_POST['submit'])) {
    ...
    if ($password && $username) {
        $sql = 'SELECT username,password FROM ensas_pfe  WHERE password = :password AND username = :username ';
        $q = $db->prepare($sql);
        $q->execute([
        ':password' => $password,
        ':username' => $username
...
<head>
    ...
    <script>
		...
		echo '<p><a href="Connectez-vous en tant que prof"></a><p>'
    </script
</head>
<body>
...
<div class="container"><br>
    ...
    <div class="row">
        <div class="button_nav">
            ...
            <a href="planning_2018-2019.html" target="_blank"><button id="planning" class="glyphicon glyphicon-calendar btn btn-info"> Planning des soutenances</button></a>
        </div>
        ...
        <div class="col-md-4" style="margin-top: 3%;">
            <div id="login" class="span3 well well-large offset4">
                ...
                <form class="form" method="post" action="index.php">
                    <label>Nom utilisateur : &nbsp; </label><input type="text" name="username" onkeyup="nospaces(this)" required/><br><br>
				...
				<input class="btn btn-success" type="submit" name="submit" value=" Connexion "/>
                    ...
                    <br><br>
                    <p><a href="admin_pfe_ensas/index.php">Connectez-vous en tant qu'Administrateur</a><p>

                        <br>
                    <p><a href="admin_pfe_ensas/index.php?user=prof">Connectez-vous en tant que Professeur</a><p>
                        <br>
                    <a href="register.php">
...
<p><a href="Connectez-vous en tant que prof"></a><p>
</html>
