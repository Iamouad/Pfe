...
$sql = "UPDATE " . $table_pfe . " SET `dateconsult`='$dateconsult' WHERE `username`='".$_SESSION['username']."'";
...
<table width="766" bgcolor="#FFFFFF" style="font-family:Tahoma; font-size:10pt; border-right-width:0px; border-top-width:0px; border-bottom-width:0px" height="130">
	<tr>
		...
		<td style="border-right-style:none; border-right-width:medium; border-top-style:none; border-top-width:medium; border-bottom-style:none; border-bottom-width:medium" bgcolor="#F4F4F0">
...
<?php echo $groupe_label ; ?> </b> </font></font>
	...
	<tr>
		...
		border-right-width:medium; border-top-style:none; border-top-width:medium; border-bottom-style:solid; border-bottom-width:1px; height: 24px;" bgcolor="">
	...
	<tr>
		...
		border-right-style:none; border-right-width:medium; border-bottom-style:none; border-bottom-width:medium" valign="top"><br>Intitulé du PFE:</td>
  ...
  <?php echo $row['sujet'] . "</a>"; ?>
	...
	<tr>
		...
		<td width="610" style="border-style: none; border-width: medium; "><?php echo $row["descr"];?> </td>
	</tr>
...
<table width="764" id="table2" bgcolor="#FFFFFF" style="border-width:0px; font-family: Tahoma; font-size: 10pt">
	<tr>
		<td bgcolor="" colspan="2" style="border-left-style:none; border-left-width:medium;
		border-right-style:none; border-right-width:medium; border-top-style:none; border-top-width:medium; 
	...
	<tr>
		...
		border-right-style:none; border-right-width:medium; border-bottom-style:none; border-bottom-width:medium" valign="top"><br>
		...
		border-right-width:medium; border-bottom-style:none; border-bottom-width:medium"><br><b><?php echo $row["entreprise"];?></b> </td>
	</tr>
	
	<tr>
		<td width="145" bgcolor="#F4F4F0" valign="top" style="border-style: none; border-width: medium">
		Coordonnés et Web:</td>
		<td width="609" style="border-style: none; border-width: medium"><?php echo $row["adresse"];?></td>
	</tr>
	...
	<tr>
		...
		<td width="609" style="border-style: none; border-width: medium"><?php echo $row["fonction"];?> </td>
	</tr>
...
<tr>
	...
	<tr>
		...
		border-right-width:medium; border-top-style:none; border-top-width:medium; border-bottom-style:solid; border-bottom-width:1px" bgcolor="#F4F4F0" colspan="2">
		&nbsp;<p align="center">
	</tr>
	</table>
...
<div align="center">
	<button class=" btn btn-success " onclick="printDiv('printableArea')" > Imprimer la fiche &nbsp; <span class="glyphicon glyphicon-print"></span></button>
</div>
<br>
<!--/email_off-->
